...
The data was collected through web-scraping of the Internet pages with the Sociology and Computing Science staff members. The data collected with this were the titles and first and last names of the individuals. Then, using an r-script, the *google scholar ids* of all staff members were scraped from the Internet. With these ids, information was obtained about the publications of the individuals, and thus the scholars with whom they published and how often they were cited. 

Information on the *gender* of the individuals was collected through an r-script that entered the first names of all staff members into the Meertens database (https://www.meertens.knaw.nl/nvb/). Based on the gender of the highest number of individuals bearing the same name, staff members were assigned a gender. Information on the *ethnicity* of staff members was collected in a similar manner. The surnames were entered into the Dutch Family Names Database (https://www.cbgfamilienamen.nl/nfb/). Depending on whether the surname appears in this database, the staff members were assigned a Dutch or non-Dutch ethnicity. The *age* of the individuals is represented by the first year of publication. 
